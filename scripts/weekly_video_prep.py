...
IMAGE_PROMPT_0: [씬0 — 16:9 landscape · 서울 한강 야경 배경에 {scene0_subject} 핵심 비주얼, {future_tech}, 남산타워·63빌딩·롯데타워 도심 스카이라인, K-tech 첨단 도시 보라빛 미래적 분석 분위기, Korean futuristic city Seoul skyline purple violet tech analytics, glowing city lights bokeh, ultra-high resolution, 16:9 landscape, no text, no letters, no watermark, no logo]
IMAGE_PROMPT_1: [씬1 — 16:9 landscape · 한강 다리 초록빛 성장 상승 이미지, 서울 도심 배경에 {scene1_subject} 역동적 비주얼, {future_tech}, K-tech 인프라 밝고 활기찬 분위기, Korean city Seoul green growth bullish energy vibrant, sunlit modern skyline, ultra-high resolution, 16:9 landscape, no text, no letters, no watermark, no logo]
IMAGE_PROMPT_2: [씬2 — 9:16 vertical · 한국 미래 도시: 한강 야경·서울 스카이라인·광화문 광장 배경에 {scene2_subject} 상징 비주얼 + 미래 비전({future_tech}), 첨단 K-tech 도시 풍경, 마젠타·골드빛 영감적 미래 무드, 황금빛 태양·별빛·반짝임, ultra-high resolution, 9:16 vertical, no text, no letters, no watermark, no logo]"""
